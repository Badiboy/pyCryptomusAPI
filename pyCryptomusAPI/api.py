...
from .webhooks import process_payment_webhook, process_payout_webhook
...
class pyCryptomusAPIException(Exception):
    """Cryptomus API request error.

    :param code: HTTP status code or internal client error code.
    :param message: Error message returned by the API or generated by the client.
    :param full_error: Full API error payload, if available.
    """
...
class pyCryptomusAPI:
    ...
    def process_payment_webhook(self, webhook):
        """
        ...
        """
        return process_payment_webhook(webhook, self.payment_api_key)

    def process_payout_webhook(self, webhook):
        """
        ...
        """
        return process_payout_webhook(webhook, self.payout_api_key)
